...
//    return driver.findElementByXPath("//XCUIElementTypeButton[@name=\"导入Keystore\"]");
    return driver.findElementByIosNsPredicate("name == \"导入Keystore\" AND type == \"XCUIElementTypeButton\"");
  }
