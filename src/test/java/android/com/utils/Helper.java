...
//        System.out.print("   " + width + "   " + height);
    ...
    @FindBy(id = "wallet.tronlink.global:id/assets_name")
    ...
    public void getCreateWallet(Boolean isNormal,String walletName,String password){
        try {
            findWebElement("wallet.tronlink.global:id/tv_import").click();
            swipUntilElementEnable("wallet.tronlink.global:id/bt_accept");
            findWebElement("wallet.tronlink.global:id/bt_accept").click();
            if (isNormal) {
                findWebElement("wallet.tronlink.global:id/create_option_desc").click();
            } else {
                findWebElement("wallet.tronlink.global:id/create_option_desc_shield").click();
            }
            TimeUnit.SECONDS.sleep(1);
            //点击创建钱包
            findWebElement("wallet.tronlink.global:id/cd_cw").click();
            findWebElement("wallet.tronlink.global:id/et_name").sendKeys(walletName);
            findWebElement("wallet.tronlink.global:id/creat").click();
            findWebElement("wallet.tronlink.global:id/et_password").sendKeys(password);
            findWebElement("wallet.tronlink.global:id/creat").click();
            //findWebElement("wallet.tronlink.global:id/creat").click();
            findWebElement("wallet.tronlink.global:id/et_password").sendKeys(password);
            findWebElement("wallet.tronlink.global:id/creat").click();
            TimeUnit.SECONDS.sleep(8);
            findWebElement("wallet.tronlink.global:id/iv_common_left").click();
            TimeUnit.SECONDS.sleep(3);
            //校验是否导入成功
            System.out.println("开始校验是否导入成功");
            findWebElement("wallet.tronlink.global:id/assets_name");
    ...
    public void getSignOperate(String testPrivateKey){
        try {
            ...
            findWebElement("wallet.tronlink.global:id/cd_pk").click();
            findWebElement("wallet.tronlink.global:id/et_content").sendKeys(testPrivateKey);
            findWebElement("wallet.tronlink.global:id/bt_next").click();
            findWebElement("wallet.tronlink.global:id/et_name").sendKeys("Auto-test");
            findWebElement("wallet.tronlink.global:id/creat").click();
            findWebElement("wallet.tronlink.global:id/et_password").sendKeys("Test0001");
            TimeUnit.SECONDS.sleep(1);
            //findWebElement("wallet.tronlink.global:id/creat").click();
            findWebElement("wallet.tronlink.global:id/creat").click();
            TimeUnit.SECONDS.sleep(1);
    ...
    public void getShieldSignOperate(String testPrivateKey){
        try {
            ...
            try {
                //新增匿名账户页面
                // 普通账户id：wallet.tronlink.global:id/create_option_desc
                //匿名账户id:wallet.tronlink.global:id/create_option_desc_shield
                findWebElement("wallet.tronlink.global:id/create_option_desc_shield").click();
            } catch (Exception e) {
    ...
    public void  getShieldWatchWalletSignOperate(String udid,String nsk,String ak,String ovk,String shieldAddress){
        try {
            ...
            //点击观察钱包
            findWebElement("wallet.tronlink.global:id/cd_ow").click();
            TimeUnit.SECONDS.sleep(1);
            ...
            findWebElement("wallet.tronlink.global:id/btn_next").click();
            findWebElement("wallet.tronlink.global:id/et_name").sendKeys("Auto-shield-test");
            findWebElement("wallet.tronlink.global:id/creat").click();
            TimeUnit.SECONDS.sleep(3);
    ...
    public void  getWatchWalletSignOperate(String address){
        try {
            ...
            findWebElement("wallet.tronlink.global:id/cd_ow").click();
            findWebElement("wallet.tronlink.global:id/et_content").sendKeys(address);
            findWebElement("wallet.tronlink.global:id/bt_next").click();
            findWebElement("wallet.tronlink.global:id/et_name").sendKeys("WatchWallet");
            findWebElement("wallet.tronlink.global:id/creat").click();
            TimeUnit.SECONDS.sleep(1);
            findWebElement("wallet.tronlink.global:id/iv_common_left").click();
            TimeUnit.SECONDS.sleep(3);
    ...
    public void  getColdWalletSignOperate(String testPrivateKey){
        try {
            findWebElement("wallet.tronlink.global:id/tv_cold_wallet").click();
            findWebElement("wallet.tronlink.global:id/tv_ok").click();
            swipUntilElementEnable("wallet.tronlink.global:id/bt_accept");
            findWebElement("wallet.tronlink.global:id/bt_accept").click();
            try {
                //新增匿名账户页面
            ...
            findWebElement("wallet.tronlink.global:id/et_content").sendKeys(testPrivateKey);
            findWebElement("wallet.tronlink.global:id/bt_next").click();
            findWebElement("wallet.tronlink.global:id/et_name").sendKeys("Cold-test");
            findWebElement("wallet.tronlink.global:id/creat").click();
            findWebElement("wallet.tronlink.global:id/et_password").sendKeys("Test0001");
            findWebElement("wallet.tronlink.global:id/creat").click();
            findWebElement("wallet.tronlink.global:id/creat").click();
            ...
            findWebElement("wallet.tronlink.global:id/creat").click();
            TimeUnit.SECONDS.sleep(1);
            findWebElement("wallet.tronlink.global:id/tv_offline_sign_desc");
            TimeUnit.SECONDS.sleep(2);
        }catch (Exception e){
            System.out.println(e);
        }
