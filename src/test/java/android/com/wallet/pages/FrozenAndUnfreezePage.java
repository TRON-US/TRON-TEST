...
public class FrozenAndUnfreezePage extends AbstractPage {
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/ll_energy_arrow")
    public WebElement freezeEnergyDetail_btn;


    @FindBy(id = "wallet.tronlink.harmony:id/tv_myfreeze")
    public WebElement myFreeze_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/tv_otherfreeze")
    public WebElement otherFreeze_btn;


    @FindBy(id = "wallet.tronlink.harmony:id/tv_totalfreeze")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/ll_bandwidth_arrow")
    public WebElement freezeBandwidthDetail_btn;


    @FindBy(id = "wallet.tronlink.harmony:id/tv_myfreeze_bandwidth")
    public WebElement myFreezeBandwidth_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/tv_otherfreeze_bandwidth")
    public WebElement otherFreezeBandwidth_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/tv_totalfreeze_bandwidth")
    public WebElement totalFreezeBandwidth_btn;


    @FindBy(id = "wallet.tronlink.harmony:id/tv_voting_power")
    public WebElement votingPower_btn;


    @FindBy(id = "wallet.tronlink.harmony:id/bandwidth_question")
    public WebElement BandwidthQuestion_btn;


    @FindBy(id = "wallet.tronlink.harmony:id/content")
    public WebElement questionContent_btn;



    @FindBy(id = "wallet.tronlink.harmony:id/select_bandwidth")
    public WebElement bandwidth_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/select_energy")
    public WebElement energy_btn;


    @FindBy(id = "wallet.tronlink.harmony:id/current_use")
    public WebElement currentCanUse_btn;


    @FindBy(id = "wallet.tronlink.harmony:id/et_freeze_count")
    public WebElement freezeCount_input;


    @FindBy(id = "wallet.tronlink.harmony:id/freeze")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/error_trx_count")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/et_freeze_address")
    public WebElement freezeAddress_input;



    @FindBy(id = "wallet.tronlink.harmony:id/iv_cancle")
    public WebElement cleanAddress_btn;



    @FindBy(id = "wallet.tronlink.harmony:id/error_address")
    public WebElement errorAddress_hits;

    @FindBy(id = "wallet.tronlink.harmony:id/select_power_type")
    public WebElement currentType_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/tv_me")
    public WebElement unfreezeType_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/tv_all")
    public WebElement freezeType_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/iv_unfreeze")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/unfreeze")
    public WebElement unfreeze_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/rl_bottom_next")
    public WebElement signNext_btn;



    @FindBy(id = "wallet.tronlink.harmony:id/tv_invalid_time")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/tv_selected_name")
    public WebElement selectSignName_text;

    @FindBy(id = "wallet.tronlink.harmony:id/rl_address_book")
    public WebElement addressBook_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/tv_address_name")
