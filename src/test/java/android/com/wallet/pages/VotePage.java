...
public class VotePage extends AbstractPage {
    ...
    @FindBy(id = "wallet.tronlink.global:id/caim_reward")
    public WebElement caim_reward;

    @FindBy(id = "wallet.tronlink.global:id/get_votes")
    public WebElement get_votes;

    @FindBy(id = "wallet.tronlink.global:id/title")
    public WebElement voteTitle_btn;

    @FindBy(id = "wallet.tronlink.global:id/tv_batch_vote")
    public WebElement tv_batch_vote;

    @FindBy(id = "wallet.tronlink.global:id/tv_canuse_trx")
    public WebElement tv_canuse_trx;

    @FindBy(id = "wallet.tronlink.global:id/tv_canuse_votes")
    public WebElement tv_canuse_votes;

    @FindBy(id = "wallet.tronlink.global:id/tv_common_right2")
    public WebElement tv_common_right2;

    @FindBy(id = "wallet.tronlink.global:id/tv_person_name")
    public WebElement firstSR;

    @FindBy(id = "wallet.tronlink.global:id/reset")
    public WebElement reset_btn;
    @FindBy(id = "wallet.tronlink.global:id/rl_bottom_next")
    public WebElement rl_bottom_next;

    @FindBy(id = "wallet.tronlink.global:id/et_vote_amount")
    public WebElement et_input;

    @FindBy(id = "wallet.tronlink.global:id/rl_vote")
    public WebElement vote_btn;

    @FindBy(id = "wallet.tronlink.global:id/btn_vote")
    public WebElement vote_page_btn;

    @FindBy(id = "wallet.tronlink.global:id/surplus_available")
    public WebElement surplusAvailableVote_text;

    @FindBy(id = "wallet.tronlink.global:id/ll_vote_select")
    ...
    @FindBy(id = "wallet.tronlink.global:id/et_input")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_vote_role")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_awards")
    ...
    @FindBy(id = "wallet.tronlink.global:id/vote_count")
    ...
    @FindBy(id = "wallet.tronlink.global:id/total_vote")
    public WebElement total_vote;

    @FindBy(id = "wallet.tronlink.global:id/rl_clear")
    public WebElement rl_clear;

    @FindBy(id = "wallet.tronlink.global:id/et_address")
    public WebElement et_address;

    @FindBy(id = "wallet.tronlink.global:id/v_common_title")
    public WebElement v_common_title;

    @FindBy(id = "wallet.tronlink.global:id/btn_vote")
    public WebElement btn_vote;

    @FindBy(id = "wallet.tronlink.global:id/btn_voted_update")
    public WebElement btn_voted_update;

    @FindBy(id = "wallet.tronlink.global:id/btn_voted_cancel")
