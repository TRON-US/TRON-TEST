...
//        }catch (Exception e){}
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/tv_about")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/tv_friend_invitation")
    public WebElement friendInvitation_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/address_book")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/transfer_history")
    ...
    //wallet.tronlink.harmony:id/commit_proposal
    //wallet.tronlink.harmony:id/commit_proposal
    //wallet.tronlink.harmony:id/committee_proposals
    @FindBy(id = "wallet.tronlink.harmony:id/commit_proposal")
