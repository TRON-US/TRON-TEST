...
public class DiscoverPage extends AbstractPage {
    ...
    @FindBy(id = "wallet.tronlink.global:id/iv_one")
    public WebElement search_btn;

    @FindBy(id = "wallet.tronlink.global:id/tv_ok")
    public WebElement tv_ok;

    @FindBy(id = "wallet.tronlink.global:id/ll_close")
    ...
    @FindBy(id = "wallet.tronlink.global:id/url_entrance_view")
    public WebElement url_entrance_view;

    //wallet.tronlink.global:id/tv_title
    ...
    @FindBy(id = "wallet.tronlink.global:id/middle_title")
    public WebElement middle_title;

    @FindBy(id = "wallet.tronlink.global:id/tv_type")
    public WebElement tv_type_title;


    //wallet.tronlink.global:id/imageview
    @FindBy(id = "wallet.tronlink.global:id/imageview")
    public WebElement search_history_btn;

    //wallet.tronlink.global:id/iv_scan
    @FindBy(id = "wallet.tronlink.global:id/iv_scan")
    public WebElement qr_scan_btn;

    //wallet.tronlink.global:id/tv_search
    @FindBy(id = "wallet.tronlink.global:id/tv_search")
    public WebElement search_icon_in_searchPage_btn;

    //wallet.tronlink.global:id/tv_name
