...
public class CommitteeProposalPage extends AbstractPage {
    ...
    @FindBy(id = "wallet.tronlink.global:id/title_all_votes")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_create_propose")
    ...
    @FindBy(id = "wallet.tronlink.global:id/iv_agree")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_proposals_id")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_my_proposals")
    public WebElement myProposals_text;



    @FindBy(id = "wallet.tronlink.global:id/tv_approved_proposals")
