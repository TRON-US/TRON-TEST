...
public class AddressBookPage extends AbstractPage {
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_bg_right")
    public WebElement save_btn;

    @FindBy(id = "wallet.tronlink.global:id/et_address_name")
    public WebElement addName_input;

    @FindBy(id = "wallet.tronlink.global:id/et_address")
    public WebElement addAddress_input;

    @FindBy(id = "wallet.tronlink.global:id/et_description")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_description")
    public WebElement note_display;

    @FindBy(id = "wallet.tronlink.global:id/rl_address_copy")
    public WebElement copy_btn;

    @FindBy(id = "wallet.tronlink.global:id/rl_address_edit")
    public WebElement edit_btn;

    @FindBy(id = "wallet.tronlink.global:id/iv_delete")
    public WebElement deleteBook_btn;

    @FindBy(id = "wallet.tronlink.global:id/rl_delete")
    ...
    @FindBy(id = "wallet.tronlink.global:id/rl_scan")
    public WebElement scan_btn;

    @FindBy(id = "wallet.tronlink.global:id/tv_name_error")
    public WebElement nameError_info;

    @FindBy(id = "wallet.tronlink.global:id/tv_address_error")
    public WebElement addressError_info;

    @FindBy(id = "wallet.tronlink.global:id/tv_msg")
