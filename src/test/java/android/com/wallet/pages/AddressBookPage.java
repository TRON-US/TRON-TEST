...
public class AddressBookPage extends AbstractPage {
    ...
    @FindBy(id = "com.tronlink.global:id/tv_description")
    public WebElement note_display;

    @FindBy(id = "com.tronlink.global:id/rl_address_copy")
    public WebElement copy_btn;

    @FindBy(id = "com.tronlink.global:id/rl_address_edit")
    public WebElement edit_btn;

    @FindBy(id = "com.tronlink.global:id/iv_delete")
    public WebElement deleteBook_btn;

    @FindBy(id = "com.tronlink.global:id/rl_delete")
    ...
    @FindBy(id = "com.tronlink.global:id/rl_scan")
    public WebElement scan_btn;

    @FindBy(id = "com.tronlink.global:id/tv_name_error")
    public WebElement nameError_info;

    @FindBy(id = "com.tronlink.global:id/tv_address_error")
    public WebElement addressError_info;

    @FindBy(id = "com.tronlink.global:id/tv_msg")
