...
public class TransactionRecordPage extends AbstractPage {
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/tv_three")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/root_view")
    public List<WebElement> transactionRecords;

    @FindBy(id = "wallet.tronlink.harmony:id/tv_contract_title")
    public List<WebElement> transactionTypeList;

    @FindBy(id = "wallet.tronlink.harmony:id/tv_contract_title")
    public WebElement transactionType;

    @FindBy(id = "wallet.tronlink.harmony:id/tv_two")
    public WebElement freezeDetail;

    @FindBy(id = "wallet.tronlink.harmony:id/tv_one")
