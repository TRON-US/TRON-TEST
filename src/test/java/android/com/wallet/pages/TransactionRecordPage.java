...
public class TransactionRecordPage extends AbstractPage {
    ...
    @FindBy(id = "com.tronlink.global:id/tv_three")
    ...
    @FindBy(id = "com.tronlink.global:id/root_view")
    public List<WebElement> transactionRecords;

    @FindBy(id = "com.tronlink.global:id/tv_contract_title")
    public List<WebElement> transactionTypeList;

    @FindBy(id = "com.tronlink.global:id/tv_contract_title")
    public WebElement transactionType;

    @FindBy(id = "com.tronlink.global:id/tv_two")
    public WebElement freezeDetail;

    @FindBy(id = "com.tronlink.global:id/tv_one")
