...
public class WalletPasswordPage extends AbstractPage {
  ...
  @FindBy(id = "wallet.tronlink.harmony:id/et_oldpassword")
  public WebElement oldPassword_et;

  @FindBy(id = "wallet.tronlink.harmony:id/et_newpassword")
  public WebElement newPassword_et;

  @FindBy(id = "wallet.tronlink.harmony:id/et_confirm_password")
  public WebElement confirmPassword_et;

  @FindBy(id = "wallet.tronlink.harmony:id/ok")
