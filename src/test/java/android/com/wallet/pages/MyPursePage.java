...
public class MyPursePage extends AbstractPage {
    ...
    @FindBy(id = "wallet.tronlink.global:id/rl_sign_manager")
    ...
    @FindBy(id = "wallet.tronlink.global:id/rl_password")
    public WebElement walletPassword_btn;




    //@FindBy(id = "wallet.tronlink.global:id/tv_create")
    //public WebElement newCreate_btn;

    @FindBy(id = "wallet.tronlink.global:id/iv_create")
    public WebElement newCreate_btn;
    ...
    @FindBy(id = "wallet.tronlink.global:id/rl_keystore2")
    public WebElement backupKeystore_btn;

    @FindBy(id = "wallet.tronlink.global:id/rl_privatekey")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_keystore")
    public WebElement keystore_text;




    @FindBy(id = "wallet.tronlink.global:id/backup")
    ...
    @FindBy(id = "wallet.tronlink.global:id/editText")
    public WebElement sk_text;

    @FindBy(id = "wallet.tronlink.global:id/editText")
    public WebElement shieldAddress_text;

    @FindBy(id = "wallet.tronlink.global:id/bt_know")
