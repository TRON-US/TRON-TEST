...
public class SendTrxPage extends AbstractPage {
    ...
    //wallet.tronlink.global:id/toscan
    @FindBy(id = "wallet.tronlink.global:id/toscan")
    ...
    @FindBy(id = "wallet.tronlink.global:id/iv_one_delete")
    public WebElement transferAddress_deleteBtn;

    @FindBy(id = "wallet.tronlink.global:id/et_transfer_address")
    ...
    @FindBy(id = "wallet.tronlink.global:id/et_count")
    public WebElement tranferCount_text;

    @FindBy(id = "wallet.tronlink.global:id/send")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_from_address")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_real_money")
    public WebElement real_money;

    @FindBy(id = "wallet.tronlink.global:id/tv_fee")
    public WebElement fee_text;

    @FindBy(id = "wallet.tronlink.global:id/tv_add_address")
    public WebElement tv_add_address;

    @FindBy(id = "wallet.tronlink.global:id/tv_fee_amount_bw")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_max")
    public WebElement tvMax_btn;


    @FindBy(id = "wallet.tronlink.global:id/rl_token")
...
//    public WebElement trc20_btn;
    ...
    @FindBy(id = "wallet.tronlink.global:id/rl_addressbook_receive")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_add_note")
    public WebElement add_note;

    @FindBy(id = "wallet.tronlink.global:id/et_note")
    public WebElement et_note;

    @FindBy(id = "wallet.tronlink.global:id/tv_delete")
    public WebElement tv_delete;

    @FindBy(id = "wallet.tronlink.global:id/iv_logo")
