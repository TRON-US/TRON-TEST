...
public class NodeSetPage extends AbstractPage {
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_dappchain_node_name")
    public  WebElement dappChainName;

    @FindBy(id = "wallet.tronlink.global:id/iv_dappchain_select")
    public  WebElement dappChainBtn;

    @FindBy(id = "wallet.tronlink.global:id/tv_mainnet_node_name")
    public  WebElement mainChainName;

    @FindBy(id = "wallet.tronlink.global:id/iv_mainnet_select")
    public  WebElement mainChainBtn;

    @FindBy(id = "wallet.tronlink.global:id/tv_shasta_node_name")
    public WebElement shastaName;

    @FindBy(id = "wallet.tronlink.global:id/iv_shasta_select")
