...
public class NodeSetPage extends AbstractPage {
    ...
    @FindBy(id = "com.tronlink.global:id/tv_dappchain_node_name")
    public  WebElement dappChainName;

    @FindBy(id = "com.tronlink.global:id/iv_dappchain_select")
    public  WebElement dappChainBtn;

    @FindBy(id = "com.tronlink.global:id/tv_mainnet_node_name")
    public  WebElement mainChainName;

    @FindBy(id = "com.tronlink.global:id/iv_mainnet_select")
    public  WebElement mainChainBtn;

    @FindBy(id = "com.tronlink.global:id/tv_shasta_node_name")
    public WebElement shastaName;

    @FindBy(id = "com.tronlink.global:id/iv_shasta_select")
