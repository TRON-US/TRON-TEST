...
//
    ...
    @FindBy(id = "wallet.tronlink.global:id/rl_deal_sign_tip")
    public WebElement mutisign_tipview;



    @FindBy(id = "wallet.tronlink.global:id/iv_sign_close")
    public WebElement mutisign_closebtn;



    @FindBy(id = "wallet.tronlink.global:id/top")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_money_value")
    public WebElement abountmoneyvalue;

    @FindBy(id = "wallet.tronlink.global:id/tv_trx_value")
    ...
    @FindBy(id = "wallet.tronlink.global:id/rl_safe_tip")
    public WebElement safe_tip;



    @FindBy(id="wallet.tronlink.global:id/iv_vote")
    public WebElement vote_btn;



    @FindBy(id="wallet.tronlink.global:id/appmarket")
    ...
    @FindBy(id="wallet.tronlink.global:id/rl_receive")
    public WebElement receipt_btn;



    @FindBy(id = "wallet.tronlink.global:id/iv_add_assets")
    ...
    @FindBy(id = "wallet.tronlink.global:id/rl_bg_freeze")
    ...
    @FindBy(id = "wallet.tronlink.global:id/app1")
    ...
    @FindBy(id = "wallet.tronlink.global:id/rl_main")
...
/*    @FindBy(xpath = "//*[@text='TRX']")
    ...
    //wallet.tronlink.global:id/rl_main
    @FindBy(id = "wallet.tronlink.global:id/rl_main")
    public List<WebElement> trx20_btn;
    ...
    //wallet.tronlink.global:id/iv_renzheng
    @FindBy(id = "wallet.tronlink.global:id/iv_renzheng")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_chain_name")
    ...
    @FindBy(className = "wallet.tronlink.global:id/tv_walletname")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_current_block")
    public WebElement synCurrent_blockNum;

    @FindBy(id = "wallet.tronlink.global:id/tv_block_amount")
    ...
    //wallet.tronlink.global:id/tv_common_right2
    ...
    public MarketPage enterMarketPage() {
        ...
        try{
            ...
            driver.findElementById("wallet.tronlink.global:id/rl_bg_just_swap").click();
            findElementByText("行情").click();
        }
