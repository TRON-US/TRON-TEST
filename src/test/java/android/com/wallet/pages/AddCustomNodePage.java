...
public class AddCustomNodePage extends AbstractPage {
    ...
    @FindBy(id = "wallet.tronlink.global:id/et_node_ip")
    public WebElement nodeIp_input;

    @FindBy(id = "wallet.tronlink.global:id/et_node_port")
    public WebElement nodePort_input;

    @FindBy(id = "wallet.tronlink.global:id/bt_next")
    public WebElement save_btn;


    @FindBy(id = "wallet.tronlink.global:id/bt_delete")
