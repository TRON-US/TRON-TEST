...
public class ProposalDetailsPage extends AbstractPage {
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/tv_proposals_cancle")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/tv_proposals_state")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/tv_proposals_name")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/num_valid_votes")
    public WebElement numValidVotes_btn;




    @FindBy(id = "wallet.tronlink.harmony:id/tv_create_time")
    public WebElement createTime_text;



    @FindBy(id = "wallet.tronlink.harmony:id/tv_end_time")
    public WebElement endTime_text;



    @FindBy(id = "wallet.tronlink.harmony:id/tv_no_approvers")
