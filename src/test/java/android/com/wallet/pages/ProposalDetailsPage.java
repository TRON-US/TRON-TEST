...
public class ProposalDetailsPage extends AbstractPage {
    ...
    @FindBy(id = "com.tronlink.global:id/tv_proposals_cancle")
    ...
    @FindBy(id = "com.tronlink.global:id/num_valid_votes")
    public WebElement numValidVotes_btn;




    @FindBy(id = "com.tronlink.global:id/tv_create_time")
    public WebElement createTime_text;



    @FindBy(id = "com.tronlink.global:id/tv_end_time")
    public WebElement endTime_text;



    @FindBy(id = "com.tronlink.global:id/tv_no_approvers")
