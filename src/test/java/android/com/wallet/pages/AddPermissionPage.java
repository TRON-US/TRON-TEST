...
public class AddPermissionPage extends AbstractPage {
    ...
    @FindBy(id = "wallet.tronlink.global:id/et_permission_name")
    public WebElement permissionName_input;



    @FindBy(id = "wallet.tronlink.global:id/tv_operation")
    public WebElement weights_btn;



    @FindBy(id = "wallet.tronlink.global:id/et_threshold")
    public WebElement threshold_input;



    @FindBy(id = "wallet.tronlink.global:id/et_key_address")
    public List<WebElement> address_input;

    @FindBy(id = "wallet.tronlink.global:id/et_key_address")
    public WebElement addressinput;

    @FindBy(id = "wallet.tronlink.global:id/et_weight")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_confirm")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_permissionname_tip")
    public WebElement tip_hits;



    @FindBy(id = "wallet.tronlink.global:id/tv_operations_tip")
    public WebElement operations_tip;



    @FindBy(id = "wallet.tronlink.global:id/tv_threshold_tip")
    ...
    @FindBy(id = "wallet.tronlink.global:id/tv_addkey_tip")
    public WebElement addkey_tip;



    @FindBy(id = "wallet.tronlink.global:id/rl_add_key_button")
    public WebElement addKey_btn;



    @FindBy(id = "wallet.tronlink.global:id/tv_title")
    ...
    @FindBy(id = "wallet.tronlink.global:id/bt_confirm")
