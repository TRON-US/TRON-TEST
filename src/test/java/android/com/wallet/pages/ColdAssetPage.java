...
public class ColdAssetPage extends AbstractPage {
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/ll_receive")
    public WebElement receive_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/ll_offline_sign")
    public WebElement offlineSign_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/tv_nonet_desc")
    public WebElement coldWalletKnowledge_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/iv_nonet_tip_close")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/bt_copy")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/iv_wallet_manager")
    public WebElement addWallet_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/cd_pk")
    public WebElement privateKey_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/cd_kt2")
    public WebElement keystore_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/cd_cw")
    public WebElement createWallet_btn;

    @FindBy(id = "wallet.tronlink.harmony:id/rl_mm")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/create_opt_general")
