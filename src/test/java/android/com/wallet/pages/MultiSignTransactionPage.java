...
public class MultiSignTransactionPage extends AbstractPage {
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/bt_sign")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/tv_note_more")
    public WebElement tv_note_more;

    @FindBy(id = "wallet.tronlink.harmony:id/tv_cancle")
    public WebElement tv_cancle;

    @FindBy(id = "wallet.tronlink.harmony:id/tv_sign_success")
    public WebElement signSuccess_tab;



    @FindBy(id = "wallet.tronlink.harmony:id/tv_trans_type")
    public WebElement trans_text;



    @FindBy(id = "wallet.tronlink.harmony:id/tv_trans_content")
    public WebElement transContent_text;




    @FindBy(id = "wallet.tronlink.harmony:id/transaction_from")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/tv_sign_already")
    public WebElement transactionAlreadySign_text;



    @FindBy(id = "wallet.tronlink.harmony:id/transaction_to")
    ...
    @FindBy(id = "wallet.tronlink.harmony:id/cv_countdownView")
