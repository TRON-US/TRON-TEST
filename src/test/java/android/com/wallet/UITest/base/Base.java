...
//    }
    ...
    public  void changeDappchain() throws Exception{
        try {
            ...
            if (DRIVER.findElementById("wallet.tronlink.harmony:id/iv_pic").isDisplayed()){
                DRIVER.findElementById("wallet.tronlink.harmony:id/iv_close").click();
                TimeUnit.SECONDS.sleep(1);
            }
        }catch (Exception e){}
        DRIVER.findElementById("wallet.tronlink.harmony:id/my").click();
        TimeUnit.SECONDS.sleep(1);
        DRIVER.findElementById("wallet.tronlink.harmony:id/setting").click();
        TimeUnit.SECONDS.sleep(1);
        DRIVER.findElementById("wallet.tronlink.harmony:id/node").click();
        TimeUnit.SECONDS.sleep(1);
