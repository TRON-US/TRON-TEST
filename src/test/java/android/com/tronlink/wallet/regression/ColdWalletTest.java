...
public class ColdWalletTest extends Base {
    ...
    public void test010_coldWalletCloseSafeTipsTest() throws Exception {
        ...
        waiteTime();
        coldAsset.driver.findElementById("wallet.tronlink.harmony:id/et_name").sendKeys("SafeTipsM");
        waiteTime();
        coldAsset.driver.findElementById("wallet.tronlink.harmony:id/creat").click();
        waiteTime();
        coldAsset.driver.findElementById("wallet.tronlink.harmony:id/et_password").sendKeys("Test0001");
        waiteTime();
        coldAsset.driver.findElementById("wallet.tronlink.harmony:id/creat").click();
        waiteTime();
        coldAsset.driver.findElementById("wallet.tronlink.harmony:id/et_password").sendKeys("Test0001");
        ...
        if (coldAsset.isElementExist("wallet.tronlink.harmony:id/rl_safe_tip")){
            log("开始测试关闭备份助记词提示框");
            coldAsset.driver.findElementById("wallet.tronlink.harmony:id/iv_close").click();
            TimeUnit.SECONDS.sleep(1);
            Assert.assertFalse(coldAsset.isElementExist("wallet.tronlink.harmony:id/rl_safe_tip"));
        }
    ...
    public void test011_coldWalletDeleteSafeTipsWallet() throws Exception {
        ...
        TimeUnit.SECONDS.sleep(5);
        waiteTime();
        coldAsset.driver.findElementById("wallet.tronlink.harmony:id/delete").click();
        TimeUnit.SECONDS.sleep(3);
        waiteTime();
        coldAsset.driver.findElementById("wallet.tronlink.harmony:id/et_password").sendKeys("Test0001");
        waiteTime();
        coldAsset.driver.findElementById("wallet.tronlink.harmony:id/tv_ok").click();
        waiteTime();
        TimeUnit.SECONDS.sleep(5);
