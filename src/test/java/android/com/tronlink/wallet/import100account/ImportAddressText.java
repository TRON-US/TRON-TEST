...
public class ImportAddressText extends Base {
    ...
    public void test001_importAddress() throws Exception {
        findWebElement("com.tronlink.global:id/my").click();
        findWebElement("com.tronlink.global:id/address_book").click();
        for (int i = 0; i < addressList.length; i++) {
            findWebElement("com.tronlink.global:id/iv_qr").click();

            findWebElement("com.tronlink.global:id/et_address_name").sendKeys("Auto_AddressText_" + (i+1));
            findWebElement("com.tronlink.global:id/et_address").sendKeys(addressList[i]);
            findWebElement("com.tronlink.global:id/et_description").sendKeys("Description_" + (i+1));
            findWebElement("com.tronlink.global:id/tv_bg_right").click();
