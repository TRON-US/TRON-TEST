...
public class DappFrozenTest extends Base {
    ...
    public void test0014_dappChainFreezeTransactionRecord() throws Exception {
        ...
        String transactionType = transaction.transactionRecords.get(0).findElement(By.id("wallet.tronlink.global:id/tv_contract_title")).getText();
        String resourceType = transaction.transactionRecords.get(0).findElement(By.id("wallet.tronlink.global:id/tv_two")).getText();
