...
public class MutiSignature {
    ...
    public void test01MutiSignScreen() {
        ...
        TronLink.testOperation(driver,TronLink.permissionNameInputId,"input",activePermissionName,"input permission name");
        ...
        TronLink.testOperation(driver,TronLink.thresholdInAddPermissionInputId,"input",String.valueOf(50),"Input threshold");

        TronLink.testOperation(driver,TronLink.permissionAddressInputId,"input",TronLink.activePermissionManager1Address,"Input manager 1 address");
